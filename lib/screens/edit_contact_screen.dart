...
class EditContactScreen extends StatefulWidget {
  ...
  const EditContactScreen({super.key, required this.id});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<ContactBloc, ContactState>(
      listener: (context, state) {
        ...
        if (state is ContactFinish) {
          setState(() {
            fullNameController.text = state.contact!.name ?? '';
            emailController.text = state.contact!.email ?? '';
            phoneNumberController.text = state.contact!.phoneNumber ?? '';
            addressController.text = state.contact!.address ?? '';
          });
        }
      },
